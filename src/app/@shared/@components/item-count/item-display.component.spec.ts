...
describe('ItemDisplayComponent', () => {
  ...
  it('should display base count and link', () => {
    ...
    expect(baseLink.nativeElement.getAttribute('href')).toContain('/item/123');
  });
  ...
  it('should display enchanted count and link', () => {
    ...
    expect(enchantedLink.nativeElement.getAttribute('href')).toContain(`/item/${123 + ItemQuality.Enchanted}`);
  });
  ...
  it('should display legendary count and link', () => {
    ...
    expect(legendaryLink.nativeElement.getAttribute('href')).toContain(`/item/${2021995}`);
  });
